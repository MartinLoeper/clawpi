...
echo "Model files saved to: output/hey_claw/"
echo "  hey_claw.onnx   — for openWakeWord (ONNX Runtime)"
echo "  hey_claw.tflite  — for openWakeWord (TFLite)"
echo ""
echo "To test with your microphone:"
echo "  python openwakeword/examples/detect_from_microphone.py --model_path output/hey_claw/hey_claw.tflite"
echo ""
echo "To deploy to the Pi, copy the .tflite file and set:"
echo "  services.clawpi.voice.wakewordModel = ./training/output/hey_claw/hey_claw.tflite;"
